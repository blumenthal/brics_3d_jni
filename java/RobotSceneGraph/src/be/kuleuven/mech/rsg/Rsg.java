...
public class Rsg {
	 ...
	 * It (a) loads the shared library and (b) calls the respective
	 * initialize function. 
	...
	/**
	 * @brief Resent the complete world model to all the listeners. 
	 * @return  True on success.
	 */
	...
	/**
	 * Iff a path is set, the dot files as generated by the DotVisualizer
	 * are stored.
	 * @param fileName Folder where the dot files are stored.
	 */	
	public static boolean setDotFilePath (String pathName) {
		return RsgJNI.setDotFilePath(pathName);
	}
